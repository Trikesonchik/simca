...
public class TControllerOCNS
        ...
        implements Runnable,
        IControllerOCNS {
    private static /* synthetic */ int[] $SWITCH_TABLE$network$TCommandOCNS;
    ...
    static /* synthetic */ int[] $SWITCH_TABLE$network$TCommandOCNS() {
        int[] arrn;
    ...
    public boolean AddCommand(TCommandOCNS aCommandOCNS) {
