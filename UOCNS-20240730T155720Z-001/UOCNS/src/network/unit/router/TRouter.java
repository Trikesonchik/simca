...
import network.unit.router.link.TPLinkRx;
...
public class TRouter
    ...
    private int fId;
    private int fCountPLink;
    private int fCountVLinkPerPLink;
    private TCore[] fArrConnectedCore;
    private IRouter[] fArrConnectedRouter;
    private int[] fArrVLinkLastServed;
    private TPLinkRx[] fArrPLinkRx;
    private TPLinkTx[] fArrPLinkTx;
    private boolean[] fArrIsUsedPLinkTx;
    private int[] fArrCrossbar;
