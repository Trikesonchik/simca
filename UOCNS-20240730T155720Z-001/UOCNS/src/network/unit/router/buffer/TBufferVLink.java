...
public final class TBufferVLink
    ...
    private ArrayBlockingQueue<TFlit> FBufferFifo;
    ...
    public boolean canPushHead(int iClock) {
        if (this.fClockPush < iClock && this.FBufferFifo.isEmpty() && this.fPacketFlitsRemain == 0) {
            return true;
        }
        return false;
    }
    ...
    public boolean canPushData(int iClock) {
        if (this.fClockPush < iClock && this.FBufferFifo.remainingCapacity() > 0 && this.fPacketFlitsRemain > 0) {
            return true;
        }
        return false;
    }
    ...
    public boolean canPop(int iClock) {
        if (this.fClockPop < iClock && !this.FBufferFifo.isEmpty()) {
            return true;
        }
        return false;
    }
