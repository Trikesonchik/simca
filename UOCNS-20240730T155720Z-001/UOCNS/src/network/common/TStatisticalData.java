...
import network.IControllerOCNS;

public class TStatisticalData {
    private long[] fArrCountRouterFlitTx;
    private long[] fArrCountCoreFlitTx;
    private long[] fArrCountPacketTime;
    private long[] fArrCountNewPacketWell;
    private long[] fArrCountNewPacketErr;
    private long[] fArrCountPacketRx;
    private long[] fArrCountPacketTx;
    private long[] fArrCountCoreFlitRx;
    private long[] fArrCountUsedRouterPLinkTx;
    private long[] fArrCountRouterPLink;
    private long[] fArrCountUsedCorePLinkTx;
    private long[] fArrCountUsedRouterSlotRx;
    private long[] fArrCountUsedRouterSlotTx;
    private long[] fArrCountUsedCoreSlotRx;
    private long[] fArrCountUsedCoreSlotTx;
    private long[] fArrCountPacketHop;
    private long fCountWarmUpPacketToRx;
    private IControllerOCNS fControllerOCNS;
    ...
    private boolean IsWarmUp() {
        if (this.fCountWarmUpPacketToRx > 0) {
            return true;
        }
        return false;
    }
    ...
    public void incCountUsedRouterSlotRx(int aRouterId, int aCountUsedSlotRx) {
        ...
        int n = aRouterId;
        arrl[n] = arrl[n] + (long) aCountUsedSlotRx;
    }
    ...
    public void incCountUsedRouterSlotTx(int aRouterId, int aCountUsedSlotTx) {
        ...
        int n = aRouterId;
        arrl[n] = arrl[n] + (long) aCountUsedSlotTx;
    }
    ...
    public void incCountUsedCoreSlotRx(int aCoreId, int aCountUsedSlotsRx) {
        ...
        int n = aCoreId;
        arrl[n] = arrl[n] + (long) aCountUsedSlotsRx;
    }
    ...
    public void incCountUsedCoreSlotTx(int aCoreId, int aCountUsedSlotsTx) {
        ...
        int n = aCoreId;
        arrl[n] = arrl[n] + (long) aCountUsedSlotsTx;
    }
    ...
    public double getFlitRatePerNode() {
        ...
        System.err.printf("\u041d\u0435 \u043e\u0431\u0440\u0430\u0431\u043e\u0442\u0430\u043d \u0441\u043b\u0443\u0447\u0430\u0439, \u043a\u043e\u0433\u0434\u0430 \u043f\u0430\u043a\u0435\u0442 \u0438\u043c\u0435\u0435\u0442 \u043f\u0435\u0440\u0435\u043c\u0435\u043d\u043d\u0443\u044e \u0434\u043b\u0438\u043d\u0443.", new Object[0]);
        return -1.0;
    }
    ...
    public double getThroughputSwitch() {
        ...
        double aThroughputSwitch = (double) aTotalCountSwitchFlitLeft / (double) IConstants.fConfigNoC.fCountClocksTotal / (double) IConstants.fConfigNoC.fRoutingTable.length;
        return aThroughputSwitch;
    }
